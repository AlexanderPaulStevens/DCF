...
def create_dcf_visualization(
    ticker="AAPL",
    enterprise_value=1.94e12,
    equity_value=1.85e12,
    share_price=120.46,
    forecast_years=5,
):
    """
...
def create_summary_dashboard(ax, ticker, enterprise_value, equity_value, share_price):
...
def create_value_breakdown(ax, enterprise_value, equity_value):
...
def create_cash_flow_projection(ax, forecast_years):
...
def create_sensitivity_analysis(ax, base_share_price):
...
def create_valuation_metrics(ax, share_price):
